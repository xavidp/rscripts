...
#path.shp.codis.territorials <- "codis_territorials/shp/cnig.es/Poblacines_v0/"
...
st_write(mun.c, file.path(path.shp.codis.territorials, "..","mun.ine.centroids.wgs84.csv"),
